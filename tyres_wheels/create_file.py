...
from common import create_need_data
...
from connect_mysql import check_and_write_v4, check_write_json_v4, standart_product_v2
...
create_ym_xml(without_db=False, stocks_is_null=False)
# create_ym_xml()
# clean_standart_data()
