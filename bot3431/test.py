...
respose_ym = {
    "pager": {
        ...
        {"id": 451638056, "status": "CANCELLED", "substatus": "CUSTOM", "creationDate": "02-05-2024 11:27:13",
         ...
         "paymentMethod": "YANDEX", "fake": False,
         "items": [{"id": 591927025, "offerId": "TRIALLIGT990",
        ...
        {"id": 451559269, "status": "CANCELLED", "substatus": "CUSTOM", "creationDate": "02-05-2024 07:46:54",
         ...
         "paymentMethod": "YANDEX", "fake": False,
         "items": [{"id": 591838099, "offerId": "LUZARLRC0192B",
         ...
         "delivery": {"type": "PICKUP", "serviceName": "\u0421\u0430\u043c\u043e\u0432\u044b\u0432\u043e\u0437",
                      ...
                      "address": {"country": "\u0420\u043e\u0441\u0441\u0438\u044f",
                                  ...
                                  "gps": {"latitude": 54.34214, "longitude": 48.364944}},
                      "deliveryServiceId": 686811,
...
response_ps_get_orders = {
    ...
    "orders": [
            ...
            "order_items": [
                {
                    ...
                    "sys_info": {
                        ...
                        "price_item_id": 3069861927, "raw_make_name": "STELLOX",
                        "requested_oem": "8733016SX",
                        "visible_sup_logo": "ARMTEK_EMAIL_SPb", "central_warehouse": False,
                        "client_visible_cost": 5870,
        ...
        {"id": 70487, "order_id": 70487, "customer_id": 2063,
         ...
         "delivery_type": "Доставка", "roistat_visit": None, "order_items": [
            {"id": 85843, "region_order_item_id": None, "divided_order_item_id": None, "supplier_order_item_id": None,
             ...
             "qnt_confirmed": 0, "qnt_accept": None, "qnt_income": None, "weight": None, "volume_weight": 0,
             "length": None, "width": None, "height": None, "gtd": None,
             "country": None, "status_id": 13,
             "supplier_status_name": None, "check_best_price_status_id": None,
         ...
         "updated_at": "2024-05-22T13:52:43.944+03:00"},
        {"id": 70485, "order_id": 70485, "customer_id": 2063,
        ...
        {"id": 70483, "order_id": 70483, "customer_id": 2063,
         ...
         "updated_at": "2024-05-22T13:51:22.511+03:00"},
        {"id": 70482, "order_id": 70482, "customer_id": 2063,
         "order_person": {"family_name": None, "second_name": None,
                          "name": None}, "auto_id": None,
        ...
        {"id": 70481, "order_id": 70481, "customer_id": 2063,
         ...
         "updated_at": "2024-05-22T13:50:28.028+03:00"},
        {"id": 70479, "order_id": 70479, "customer_id": 2063,
         "order_person": {"family_name": None, "second_name": None,
                          "name": None}, "auto_id": None,
        ...
        {"id": 70474, "order_id": 70474, "customer_id": 2063,
         ...
         "updated_at": "2024-05-22T13:47:57.282+03:00"},
        {"id": 70473, "order_id": 70473, "customer_id": 2063,
         "order_person": {"family_name": None, "second_name": None,
                          "name": None}, "auto_id": None,
        ...
        {"id": 70471, "order_id": 70471, "customer_id": 2063,
         ...
         "updated_at": "2024-05-22T13:46:27.020+03:00"},
        {"id": 70469, "order_id": 70469, "customer_id": 2063,
         "order_person": {"family_name": None, "second_name": None,
                          "name": None}, "auto_id": None,
        ...
        {"id": 70468, "order_id": 70468, "customer_id": 2063,
         ...
         "updated_at": "2024-05-22T13:45:29.024+03:00"},
        {"id": 70467, "order_id": 70467, "customer_id": 2063,
         "order_person": {"family_name": None, "second_name": None,
                          "name": None}, "auto_id": None,
...
ps_order_status_types = {
    ...
    "order_status_types": [
        ...
        {"id": 20, "name": "Возвращено", "code": "vozvrat", "description": "", "color": "b2b2b2",
         ...
         "is_set_on_accept_product_return": None, "sms_discount_groups": [],
         "email_discount_groups": [], "disable_check_status": False},
        {"id": 23, "name": "В ПРОДАЖУ", "code": "prishlo", "description": "", "color": "ff7f00", "position": None,
         "confirmation_body": "", "send_confirm": False, "font_color": "000000", "default": False, "id_1c": None,
         "sms": "", "send_sms": False, "notify_overdue_reaction": False, "notify_overdue_reaction_day": 30,
         "overdue_sms_template": "", "send_overdue_sms": False, "admin_notify_overdue_reaction": False,
         "destroy_overdue_reaction": False, "destroy_overdue_reaction_day": None, "wait_group_overdue": False,
         "destroy_status_comment": "", "is_priority": False, "send_to_outdated": False,
         "is_set_on_accept_product_return": None, "sms_discount_groups": [], "email_discount_groups": [],
         "disable_check_status": False},
        {"id": 2, "name": "В работе", "code": "commit", "description": "", "color": "d4ffaa", "position": None,
         "confirmation_body": "", "send_confirm": False, "font_color": "000000", "default": False, "id_1c": None,
         "sms": "", "send_sms": False, "notify_overdue_reaction": False, "notify_overdue_reaction_day": 3,
         "overdue_sms_template": "", "send_overdue_sms": False, "admin_notify_overdue_reaction": True,
         "destroy_overdue_reaction": False, "destroy_overdue_reaction_day": None, "wait_group_overdue": False,
         "destroy_status_comment": "", "is_priority": False, "send_to_outdated": False,
         "is_set_on_accept_product_return": None, "sms_discount_groups": [], "email_discount_groups": [],
         "disable_check_status": False},
        {"id": 8, "name": "Выдано", "code": "vydano", "description": "", "color": "ffff00", "position": None,
         "confirmation_body": "{{order_item.status.confirmation_body}}", "send_confirm": False, "font_color": "000000",
         "default": False, "id_1c": None, "sms": "Спасибо за заказ, вам начислены бонусы ", "send_sms": True,
         "notify_overdue_reaction": False, "notify_overdue_reaction_day": 3, "overdue_sms_template": "",
         "send_overdue_sms": False, "admin_notify_overdue_reaction": False, "destroy_overdue_reaction": False,
         "destroy_overdue_reaction_day": None, "wait_group_overdue": False, "destroy_status_comment": "",
         "is_priority": False, "send_to_outdated": False, "is_set_on_accept_product_return": None,
         "sms_discount_groups": [5, 28, 8, 25, 2, 9, 3, 24, 4, 1, 23], "email_discount_groups": [1],
         "disable_check_status": False},
        {"id": 21, "name": "Готово к выдаче", "code": "prishlo", "description": "", "color": "aaff56", "position": None,
         "confirmation_body": "", "send_confirm": False, "font_color": "000000", "default": False, "id_1c": None,
         "sms": "", "send_sms": False, "notify_overdue_reaction": True, "notify_overdue_reaction_day": 3,
         "overdue_sms_template": "", "send_overdue_sms": False, "admin_notify_overdue_reaction": False,
         "destroy_overdue_reaction": False, "destroy_overdue_reaction_day": None, "wait_group_overdue": False,
         "destroy_status_comment": "", "is_priority": False, "send_to_outdated": False,
         "is_set_on_accept_product_return": None, "sms_discount_groups": [], "email_discount_groups": [],
         "disable_check_status": False},
        {"id": 5, "name": "Готово к отгрузке поставщиком", "code": "transit", "description": "", "color": "e2e2e2",
         "position": None, "confirmation_body": "", "send_confirm": False, "font_color": "000000", "default": False,
         "id_1c": None, "sms": "", "send_sms": False, "notify_overdue_reaction": False,
         "notify_overdue_reaction_day": 3, "overdue_sms_template": "", "send_overdue_sms": False,
         "admin_notify_overdue_reaction": False, "destroy_overdue_reaction": False,
         "destroy_overdue_reaction_day": None, "wait_group_overdue": False, "destroy_status_comment": "",
         "is_priority": False, "send_to_outdated": False, "is_set_on_accept_product_return": None,
         "sms_discount_groups": [], "email_discount_groups": [], "disable_check_status": False},
        {"id": 17, "name": "Обрабатывается", "code": "processing", "description": "", "color": "5656ff",
         "position": None, "confirmation_body": "", "send_confirm": False, "font_color": "aaff56", "default": False,
         "id_1c": None, "sms": "", "send_sms": False, "notify_overdue_reaction": False,
         "notify_overdue_reaction_day": 3, "overdue_sms_template": "", "send_overdue_sms": False,
         "admin_notify_overdue_reaction": True, "destroy_overdue_reaction": False, "destroy_overdue_reaction_day": None,
         "wait_group_overdue": False, "destroy_status_comment": "", "is_priority": False, "send_to_outdated": False,
         "is_set_on_accept_product_return": None, "sms_discount_groups": [], "email_discount_groups": [],
         "disable_check_status": False},
        {"id": 24, "name": "Ожидает на перемещение", "code": "commit", "description": "", "color": "cccccc",
         "position": None, "confirmation_body": "", "send_confirm": False, "font_color": "", "default": False,
         "id_1c": None, "sms": "", "send_sms": True, "notify_overdue_reaction": False, "notify_overdue_reaction_day": 3,
         "overdue_sms_template": "", "send_overdue_sms": True, "admin_notify_overdue_reaction": False,
         "destroy_overdue_reaction": False, "destroy_overdue_reaction_day": None, "wait_group_overdue": False,
         "destroy_status_comment": "", "is_priority": False, "send_to_outdated": False,
         "is_set_on_accept_product_return": None, "sms_discount_groups": [5, 28, 8, 25, 2, 3, 24, 4, 1, 23],
         "email_discount_groups": [], "disable_check_status": False},
        {"id": 13, "name": "Ожидает оплаты", "code": "processing", "description": "", "color": "ffff00",
         "position": None, "confirmation_body": "", "send_confirm": False, "font_color": "000000", "default": False,
         "id_1c": None, "sms": "", "send_sms": False, "notify_overdue_reaction": False,
         "notify_overdue_reaction_day": 3, "overdue_sms_template": "", "send_overdue_sms": False,
         "admin_notify_overdue_reaction": True, "destroy_overdue_reaction": False, "destroy_overdue_reaction_day": None,
         "wait_group_overdue": False, "destroy_status_comment": "", "is_priority": False, "send_to_outdated": False,
         "is_set_on_accept_product_return": None, "sms_discount_groups": [29], "email_discount_groups": [29],
         "disable_check_status": False},
        {"id": 6, "name": "Отгружено поставщиком", "code": "supplier-accept", "description": "", "color": "007f3f",
         "position": None, "confirmation_body": "{{order_item.status.confirmation_body}}", "send_confirm": False,
         "font_color": "ffffff", "default": False, "id_1c": None, "sms": "", "send_sms": False,
         "notify_overdue_reaction": False, "notify_overdue_reaction_day": 7, "overdue_sms_template": "",
         "send_overdue_sms": False, "admin_notify_overdue_reaction": False, "destroy_overdue_reaction": False,
         "destroy_overdue_reaction_day": None, "wait_group_overdue": False, "destroy_status_comment": "",
         "is_priority": False, "send_to_outdated": False, "is_set_on_accept_product_return": None,
         "sms_discount_groups": [], "email_discount_groups": [2, 3], "disable_check_status": True},
        {"id": 27, "name": "Подготовка к возврату по просрочке.", "code": "prishlo", "description": "",
         "color": "3f7f00", "position": None, "confirmation_body": "", "send_confirm": False, "font_color": "000000",
         "default": False, "id_1c": None, "sms": "", "send_sms": False, "notify_overdue_reaction": False,
         "notify_overdue_reaction_day": 3, "overdue_sms_template": "", "send_overdue_sms": False,
         "admin_notify_overdue_reaction": True, "destroy_overdue_reaction": False, "destroy_overdue_reaction_day": None,
         "wait_group_overdue": False, "destroy_status_comment": "", "is_priority": False, "send_to_outdated": False,
         "is_set_on_accept_product_return": None, "sms_discount_groups": [],
         "email_discount_groups": [5, 28, 8, 25, 2, 3, 24, 4, 1, 23], "disable_check_status": False},
        {"id": 26, "name": "Пришло на ПВЗ Лахта", "code": "prishlo", "description": "", "color": "7fff00",
         "position": None, "confirmation_body": "", "send_confirm": True, "font_color": "000000", "default": False,
         "id_1c": None, "sms": "Ваш заказ находится на пункте выдачи Лахта", "send_sms": True,
         "notify_overdue_reaction": False, "notify_overdue_reaction_day": 3, "overdue_sms_template": "",
         "send_overdue_sms": False, "admin_notify_overdue_reaction": False, "destroy_overdue_reaction": False,
         "destroy_overdue_reaction_day": None, "wait_group_overdue": False, "destroy_status_comment": "",
         "is_priority": False, "send_to_outdated": False, "is_set_on_accept_product_return": None,
         "sms_discount_groups": [5, 28, 25, 2, 3, 24, 4, 1, 23], "email_discount_groups": [],
         "disable_check_status": False},
        {"id": 25, "name": "Пришло на ПВЗ Руставелли", "code": "prishlo", "description": "", "color": "7fff00",
         "position": None, "confirmation_body": "", "send_confirm": True, "font_color": "", "default": False,
         "id_1c": None, "sms": "", "send_sms": False, "notify_overdue_reaction": True, "notify_overdue_reaction_day": 3,
         "overdue_sms_template": "", "send_overdue_sms": False, "admin_notify_overdue_reaction": False,
         "destroy_overdue_reaction": False, "destroy_overdue_reaction_day": None, "wait_group_overdue": True,
         "destroy_status_comment": "", "is_priority": False, "send_to_outdated": False,
         "is_set_on_accept_product_return": None, "sms_discount_groups": [5, 28, 25, 2, 3, 24, 4, 1, 23],
         "email_discount_groups": [], "disable_check_status": False},
        {"id": 4, "name": "Размещено у поставщика", "code": "supplier-commit", "description": "", "color": "c4c2c2",
         "position": None,
         "confirmation_body": "Вы можете вывести его в шаблоне {{order_item.status.confirmation_body}}",
         "send_confirm": False, "font_color": "ffffff", "default": False, "id_1c": None, "sms": "", "send_sms": False,
         "notify_overdue_reaction": False, "notify_overdue_reaction_day": 3,
         "overdue_sms_template": "Заказ просрочен {{order_item.detail_name}} {{order_item.oem}} {{order_item.make_name}}, статус заказа изменился на {{order_item.status.name}}, кол. заказано {{order_item.qnt}}, актуальное кол. {{order_item.current_qnt}}",
         "send_overdue_sms": False, "admin_notify_overdue_reaction": True, "destroy_overdue_reaction": False,
         "destroy_overdue_reaction_day": 3, "wait_group_overdue": False, "destroy_status_comment": "",
         "is_priority": False, "send_to_outdated": False, "is_set_on_accept_product_return": None,
         "sms_discount_groups": [], "email_discount_groups": [], "disable_check_status": False},
        {"id": 22, "name": "Резерв. Готов к выдаче", "code": "prishlo", "description": "", "color": "d4aaff",
         "position": None, "confirmation_body": "", "send_confirm": False, "font_color": "000000", "default": False,
         "id_1c": None, "sms": "", "send_sms": False, "notify_overdue_reaction": True, "notify_overdue_reaction_day": 3,
         "overdue_sms_template": "", "send_overdue_sms": False, "admin_notify_overdue_reaction": True,
         "destroy_overdue_reaction": False, "destroy_overdue_reaction_day": 7, "wait_group_overdue": False,
         "destroy_status_comment": "", "is_priority": False, "send_to_outdated": False,
         "is_set_on_accept_product_return": None, "sms_discount_groups": [], "email_discount_groups": [],
         "disable_check_status": False},
        {"id": 10, "name": "Снят", "code": "snyat", "description": "", "color": "ff0000", "position": None,
         "confirmation_body": " {{order_item.status.confirmation_body}}", "send_confirm": False, "font_color": "ffffff",
         "default": False, "id_1c": None, "sms": "", "send_sms": False, "notify_overdue_reaction": False,
         "notify_overdue_reaction_day": 3, "overdue_sms_template": "", "send_overdue_sms": False,
         "admin_notify_overdue_reaction": False, "destroy_overdue_reaction": False,
         "destroy_overdue_reaction_day": None, "wait_group_overdue": False, "destroy_status_comment": "",
