...
class Distributor(db.Model):
    ...
    api_link = db.Column(db.String(500))
    type_downloads = db.Column(db.String(250))
    format_link_downloads = db.Column(db.String(50))
...
class DistributorPrice(db.Model):
    ...
    price_link = db.Column(db.String(500))
    type_downloads = db.Column(db.String(250))
    format_link_downloads = db.Column(db.String(50))
    is_scheduler = db.Column(db.Boolean())
    enable_sync_bd = db.Column(db.Boolean())
...
class Sales(db.Model):
    ...
    is_cancelled = db.Column(db.String(250))
    date_added = db.Column(db.String(250))
    date_modifed = db.Column(db.String(250))
    date_send_data = db.Column(db.String(250))
    date_1c = db.Column(db.String(250))
    payment_type = db.Column(db.String(250))
    summ_order = db.Column(db.String(250))
    seller_id = db.Column(db.Integer())
    delivery = db.Column(db.String(250))
