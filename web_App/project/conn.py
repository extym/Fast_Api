...
store_markup float4,
check_send_null boolean,
send_common_stocks boolean,
enable_orders_submit boolean,
enable_sync_price boolean,
enable_sync_stocks boolean,
is_1c varchar,
warehouses_id int,
warehouses_name  varchar,
warehouses TEXT,
UNIQUE (id)
)
"""
...
id SERIAL PRIMARY KEY,
i_import_donor_mp TEXT NOT NULL,
i_import_donor_store TEXT NOT NULL,
i_import_donor_role TEXT,
i_import_donor_discount  int,
i_import_donor_markup  int,
i_import_acceptor_mp TEXT NOT NULL,
i_import_acceptor_store TEXT NOT NULL,
i_import_acceptor_role TEXT,
i_import_acceptor_discount int,
i_import_acceptor_markup  int,
