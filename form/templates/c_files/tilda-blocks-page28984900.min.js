...
function t702_initPopup(recId){var rec=document.getElementById('rec'+recId);if(!rec)return;var container=rec.querySelector('.t702');if(!container)return;rec.setAttribute('data-animationappear','off');rec.setAttribute('data-popup-subscribe-inited','y');rec.style.opacity=1;var documentBody=document.body;var popup=rec.querySelector('.t-popup');var popupTooltipHook=popup.getAttribute('data-tooltip-hook');var analitics=popup.getAttribute('data-track-popup');var popupCloseBtn=popup.querySelector('.t-popup__close');var hrefs=rec.querySelectorAll('a[href*="#"]');var submitHref=rec.querySelector('.t-submit[href*="#"]');if(popupTooltipHook){var allTriggerButtons=document.querySelectorAll('a[href="'+popupTooltipHook+'"]');Array.prototype.forEach.call(allTriggerButtons,function(button){if(button){button.setAttribute('role','button');button.setAttribute('aria-haspopup','dialog')}});document.addEventListener('click',function(){var target=event.target;var href=target.closest('a[href*="#"]')?target.closest('a[href*="#"]'):!1;if(!href)return;var arrHref=href.href.split('#');if(decodeURI('#'+arrHref[1])!==popupTooltipHook)return;event.preventDefault();t702_showPopup(recId);t_onFuncLoad('t_popup__resizePopup',function(){t_popup__resizePopup(recId)});t702__lazyLoad();if(analitics){Tilda.sendEventToStatistics(analitics,popupTooltipHook)}});document.addEventListener('keydown',function(event){if(event.keyCode===13){var target=event.target;var href=target.closest('a[href="'+popupTooltipHook+'"]')?target:!1;if(!href)return;if(!window.isMobile)href.classList.add('t-popup__triggered-btn')}})}
