...
function t830_isZeroBlocksRender(callback){var firstArtboard=document.querySelector('.t396__artboard');if(!firstArtboard){callback();return}
if(firstArtboard.classList.contains('rendered')){callback()}else{firstArtboard.addEventListener('artBoardRendered',callback)}}
